...
ammotable_t ammoTable[] = {
	...
	{   16,                  1,       8,        3000,        100,       300,       300,       0,      0,      7,        5,          0,          0,          400,        35,                 0.3f,            50,              {.2f, .1f},      {0,0},              700,                0.95,               MOD_LUGER,                                 },  //	LUGER				    // 2	
	...
	{   16,                  1,       8,        2300,        100,       400,       400,       0,      0,      8,        6,          0,          0,          350,        35,                 0.4f,            50,              {.3f, .1f},      {0,0},              1000,               0.95,               MOD_REVOLVER,                              },  //	P38                     // 19
	{   16,                  1,       8,        2500,        100,       400,       400,       0,      0,      9,        7,          0,          0,          400,        35,                 0.4f,            50,              {.2f, .1f},      {0,0},              700,                0.95,               MOD_COLT,                                  },  //	TT33		             / 20
	...
	{   16,                  1,       8,        3000,        100,       300,       300,       0,      0,      7,        5,          0,          0,          400,        35,                 0.3f,            50,              {.2f, .1f},      {0,0},              700,                0.95,               MOD_SILENCER,                              },  //	SILENCED LUGER		    // 30
