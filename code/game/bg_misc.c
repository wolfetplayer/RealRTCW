...
ammotable_t ammoTable[] = {
	...
	{   90,                  1,       10,       4100,        100,       400,       400,       4000,   170,    16,       8,          0,          0,          350,        40,                 0.4f,            40,              {.2f,.2f},       {.1f, .1f},         2000,               0.90,               MOD_G43,                                   },  //	SVT40				    // 16
	{   90,                  1,       10,       4000,        100,       350,       350,       4000,   220,    16,       8,          0,          0,          350,        40,                 0.4f,            40,              {.2f,.2f},       {.1f, .1f},         2000,               0.90,               MOD_M1GARAND,                              },  //	G43				        // 17
	{   250,                 1,       50,       3500,        100,       45,        45,        2300,   100,    16,       8,          0,          0,          1200,       15,                 0.6f,            50,              {.1f, .1f},      {.1f, .1f},         1500,               0.85,               MOD_MG42M,                                 },  //	MG34                    // 18
	{   16,                  1,       8,        2400,        100,       400,       400,       0,      0,      8,        6,          0,          0,          350,        35,                 0.4f,            50,              {.3f, .1f},      {0,0},              1000,               0.95,               MOD_REVOLVER,                              },  //	P38                     // 19
	...
	{   90,                  1,       10,       4000,        100,       350,       350,       4000,   220,    16,       8,          0,          0,          350,        40,                 0.4f,            40,              {.2f,.2f},       {.1f, .1f},         2000,               0.40,               MOD_M1GARANDSCOPE                          },  //	G43 SCOPED              // 27
