...
ammotable_t ammoTable[] = {
	...
	{   16,                  1,       8,        2100,        100,       400,       400,       0,      0,      8,        6,          0,          0,          400,        35,                 0.3f,            50,              {.2f, .1f},      {0,0},              700,                0.95,               MOD_LUGER,                                 },  //	LUGER				    // 2	
	...
	{   142,                 1,       71,       2800,        100,       80,        80,        3300,   140,    7,        7,          0,          0,          1000,       15,                 0.5f,            30,              {.1f, .1f},      {0,0},              1000,               0.90,               MOD_PPSH,                                  },  //	PPSH					// 14
	{   65,                  1,       5,        2400,        100,       1400,      1400,      0,      0,      35,       15,         0,          0,          300,        50,                 0.5f,            60,              {1.0f, 1.0f},    {.1f, .1f},         2000,               0.90,               MOD_MOSIN,                                 },  //	MAUSER WITHOUT SCOPE    // 15
	{   90,                  1,       10,       4550,        100,       400,       400,       4000,   170,    16,       8,          0,          0,          350,        40,                 0.4f,            40,              {.2f,.2f},       {.1f, .1f},         2000,               0.90,               MOD_G43,                                   },  //	SVT40				    // 16
	{   90,                  1,       10,       4300,        100,       350,       350,       4000,   220,    16,       8,          0,          0,          350,        40,                 0.4f,            40,              {.2f,.2f},       {.1f, .1f},         2000,               0.90,               MOD_M1GARAND,                              },  //	G43				        // 17
	{   250,                 1,       50,       3500,        100,       45,        45,        2300,   100,    16,       8,          0,          0,          1200,       15,                 0.6f,            50,              {.1f, .1f},      {.1f, .1f},         1500,               0.85,               MOD_MG42M,                                 },  //	MG34                    // 18
	{   16,                  1,       8,        2400,        100,       450,       450,       0,      0,      8,        6,          0,          0,          350,        35,                 0.4f,            50,              {.3f, .1f},      {0,0},              1000,               0.95,               MOD_REVOLVER,                              },  //	P38                     // 19
	{   16,                  1,       8,        1800,        100,       400,       400,       0,      0,      9,        7,          0,          0,          400,        35,                 0.4f,            50,              {.2f, .1f},      {0,0},              700,                0.95,               MOD_COLT,                                  },  //	TT33		             / 20
	{   105,                 1,       35,       2800,        100,       115,       115,       4000,   170,    9,        6,          0,          0,          950,        15,                 0.4f,            30,              {.2f, .2f},      {0,0},              1000,               0.90,               MOD_THOMPSON,                              },  //	PPS43	                // 21
	...
	{   90,                  1,       10,       4300,        100,       350,       350,       4000,   220,    16,       8,          0,          0,          350,        40,                 0.4f,            40,              {.2f,.2f},       {.1f, .1f},         2000,               0.40,               MOD_M1GARANDSCOPE                          },  //	G43 SCOPED              // 27
