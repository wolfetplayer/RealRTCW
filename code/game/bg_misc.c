...
ammotable_t ammoTable[] = {
	...
	{   MAX_AMMO_FG42,       1,       20,       2000,        100,       190,       120,       0,      0,      12,       12,         0,          0,          600,        15,                 0.7f,            50,              {.1f, .1f},      {.1f, .1f},         1500,               0.90,               MOD_FG42,                                  },  //	WP_FG42					// 7
	...
	{   MAX_AMMO_M97,        1,       6,        2000,        100,       1250,      1250,      0,      0,      10,       10,         0,          0,          4500,       15,                 0.6f,            130,             {.9f, .1f},      {.9f, .1f},         1500,               0.90,               MOD_M97,                                   },  //	WP_M97                  // 20
	...
	{   MAX_AMMO_45,         1,       20,       2400,        100,       90,        90,        0,      0,      10,       10,         0,          0,          950,        15,                 0.4f,            50,              {.2f, .2f},      {.2f, .2f},         1000,               0.90,               MOD_THOMPSON,                              },  //	WP_THOMPSON				// 24
