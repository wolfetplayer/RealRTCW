...
ammotable_t ammoTable[] = {
	...
	{   16,                  1,       8,        2100,        100,       300,       300,       0,      0,      8,        6,          0,          0,          400,        35,                 0.3f,            50,              {.2f, .1f},      {0,0},              700,                0.95,               MOD_LUGER,                                 },  //	LUGER				    // 2	
	{   224,                 1,       32,       2800,        100,       135,       135,       4000,   170,    8,        6,          0,          0,          850,        15,                 0.5f,            30,              {.1f, .1f},      {0,0},              1000,               0.90,               MOD_MP40,                                  },  //	MP40					// 3
	...
	{   142,                 1,       71,       2800,        100,       80,        80,        3300,   140,    9,        7,          0,          0,          1000,       15,                 0.5f,            30,              {.1f, .1f},      {0,0},              1000,               0.90,               MOD_PPSH,                                  },  //	PPSH					// 14
	{   65,                  1,       5,        2400,        100,       1400,      1400,      0,      0,      35,       15,         0,          0,          300,        50,                 0.5f,            60,              {1.0f, 1.0f},    {.1f, .1f},         2000,               0.90,               MOD_MOSIN,                                 },  //	MAUSER WITHOUT SCOPE    // 15
	{   90,                  1,       10,       3900,        100,       400,       400,       4000,   170,    25,       12,         0,          0,          350,        40,                 0.4f,            40,              {.2f,.2f},       {.1f, .1f},         2000,               0.90,               MOD_G43,                                   },  //	SVT40				    // 16
	{   90,                  1,       10,       3500,        100,       350,       350,       4000,   220,    30,       15,         0,          0,          350,        40,                 0.4f,            40,              {.2f,.2f},       {.1f, .1f},         2000,               0.90,              MOD_M1GARAND,                              },  //	G43				        // 17
	...
	{   90,                  1,       10,       3500,        100,       350,       350,       4000,   220,    30,       15,          0,          0,          350,        40,                 0.4f,            40,              {.2f,.2f},       {.1f, .1f},         2000,               0.40,               MOD_M1GARANDSCOPE                          },  //	G43 SCOPED              // 27
	{   180,                 1,       30,       3100,        100,       85,        150,       3200,   170,    9,        7,          0,          0,          950,        15,                 0.6f,            40,              {.1f, .1f},      {0,0},              64,                 0.90,               MOD_STEN,                                  },  //	MP44		            // 28
	{   16,                  1,       8,        2100,        100,       400,       400,       0,      0,      8,        6,          0,          0,          400,        35,                 0.3f,            50,              {.2f, .1f},      {0,0},              700,                0.95,               MOD_SILENCER,                              },  //	SILENCED LUGER		    // 30
