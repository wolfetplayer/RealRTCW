...
{
	ammoTable[WP_LUGER].maxammo = 16;
	ammoTable[WP_MP40].maxammo = 224;
	ammoTable[WP_MP34].maxammo = 224;
	ammoTable[WP_STEN].maxammo = 180;
	ammoTable[WP_SILENCER].maxammo = 16;
	// 45cal
	ammoTable[WP_COLT].maxammo = 16;
	ammoTable[WP_AKIMBO].maxammo = 16;
	ammoTable[WP_THOMPSON].maxammo = 105;
	// mauserammo
	ammoTable[WP_MAUSER].maxammo = 65;
	ammoTable[WP_FG42].maxammo = 96;
	ammoTable[WP_SNIPERRIFLE].maxammo = 65;
	ammoTable[WP_FG42SCOPE].maxammo = 96;
	ammoTable[WP_G43].maxammo = 90;
	ammoTable[WP_MG42M].maxammo = 250;
	// barammo
	ammoTable[WP_M1GARAND].maxammo = 90;
	ammoTable[WP_M1GARANDSCOPE].maxammo = 90;

	ammoTable[WP_PPSH].maxammo = 142;
	// mosin
	ammoTable[WP_MOSIN].maxammo = 65;

	// revolver
	ammoTable[WP_REVOLVER].maxammo = 16;
	// throwables
	...
	// snooper
	ammoTable[WP_GARAND].maxammo = 70;
	ammoTable[WP_SNOOPERSCOPE].maxammo = 70;
