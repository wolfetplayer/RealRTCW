...
extern void holycross_Fire ( gentity_t * ent ) ;
...
extern void SP_shooter_cross ( gentity_t * ent ) ;
extern void shooter_tesla_finish_spawning ( gentity_t * ent ) ;
extern void shooter_cross_finish_spawning ( gentity_t * ent ) ;
extern void use_shooter_tesla ( gentity_t * ent , gentity_t * other , gentity_t * activator ) ;
extern void use_shooter_cross ( gentity_t * ent , gentity_t * other , gentity_t * activator ) ;
...
extern void SP_ai_ghost ( gentity_t * ent ) ;
